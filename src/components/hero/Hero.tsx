  ...
  return (
    <>
      ...
      <main className="hero">
        ...
        <div
          className={`hero-bg-number${contentVisible ? " show" : ""}`}
          aria-hidden="true"
        >
          ENGINEER
        </div>
        ...
        <div
          className={`hero-figure${figureShow ? " show" : ""}`}
          ref={heroFigureRef}
        >
        ...
        <div className={`hero-topline${contentVisible ? " show" : ""}`}>
          <p className="topline-tag">
            <span className="dot" />
            Based in Islamabad, Pakistan
          </p>
          <p className="topline-title">
            Full-Stack /<br />
            AI Engineer
          </p>
        </div>
        ...
        <div className={`hero-stats${contentVisible ? " show" : ""}`}>
          ...
          <div className="stat-row">
            <span className="stat-num accent">03</span>
            <span className="stat-key">Years building</span>
          </div>
          <div className="stat-row">
            <span className="stat-num muted">40+</span>
            <span className="stat-key">Tools &amp; frameworks</span>
          </div>
        </div>
        ...
        <div className="hero-bottom">
          ...
          <div className="hero-pitch">
            <h2 className="headline">
              {headline.map((w) => (
                <span className="word" key={w.key}>
                  <span
                    className={`word-inner${w.accent ? " accent-word" : ""}${w.visible ? " show" : ""}`}
                  >
                    {w.text}
                    {"\u00A0"}
                  </span>
            ...
            <p className={`sub${contentVisible ? " show" : ""}`}>
              Undergraduate computer scientist building production-grade
              backends, ML pipelines, and distributed systems — from FastAPI
