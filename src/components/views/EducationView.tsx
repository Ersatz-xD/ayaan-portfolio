    ...
    <section id="education" className="edu-section" ref={sectionRef}>
      ...
      <div className="edu-timeline-wrap">
        <svg
          ...
          aria-hidden="true"
        >
          <circle cx="60" cy="60" r="50" fill="none" stroke="#C81E3A" strokeWidth="1" opacity="0.4" />
          <circle cx="60" cy="60" r="34" fill="none" stroke="#FF3B4E" strokeWidth="1" opacity="0.3" />
          <circle className="edu-graphic-node n1" cx="60" cy="10" r="4" fill="#FF3B4E" />
          <circle className="edu-graphic-node n3" cx="103" cy="35" r="3" fill="#C81E3A" />
          <circle className="edu-graphic-node n5" cx="103" cy="85" r="3" fill="#C81E3A" />
          <circle className="edu-graphic-node n2" cx="60" cy="110" r="4" fill="#FF3B4E" />
          <circle className="edu-graphic-node n4" cx="17" cy="85" r="3" fill="#C81E3A" />
          <circle className="edu-graphic-node n6" cx="17" cy="35" r="3" fill="#C81E3A" />
        </svg>
...
function EducationGraphic() {
  return (
    ...
    >
      ...
      <g stroke="#C81E3A" strokeWidth="1.4" opacity="0.6">
      ...
      <g filter="url(#eduGlow)">
        <circle className="edu-graphic-node n1" cx="30" cy="100" r="8" fill="#FF3B4E" />
        <circle className="edu-graphic-node n2" cx="110" cy="40" r="5.5" fill="#C81E3A" />
        <circle className="edu-graphic-node n3" cx="110" cy="100" r="5.5" fill="#C81E3A" />
        <circle className="edu-graphic-node n4" cx="110" cy="160" r="5.5" fill="#C81E3A" />
        <circle className="edu-graphic-node n5" cx="190" cy="20" r="4.5" fill="#FF3B4E" />
        <circle className="edu-graphic-node n6" cx="190" cy="70" r="4.5" fill="#FF3B4E" />
        <circle className="edu-graphic-node n7" cx="190" cy="130" r="4.5" fill="#FF3B4E" />
        <circle className="edu-graphic-node n1" cx="190" cy="180" r="4.5" fill="#FF3B4E" />
      </g>
    </svg>
  );
}
